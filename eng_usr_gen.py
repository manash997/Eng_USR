#Enter the path of concept_dictionary here:
concept_dictionary="H_concept-to-mrs-rels.dat"
#Enter the path of TAM dictionary:
tam_mapping="/home/manash/lc4eu/dictionaries/tam_mapping.dat"
#Enter the path of USR file which needs conversion here:
usr_file="verified_sent/1"
#--------------------------------------------------------------------
